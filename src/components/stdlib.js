...
export const isstr = s =>
  'string' === typeof s || (isset(s) && s instanceof String);
...
export const objForEach = (o, f = () => {}, t = this) =>
  objKeys(o).forEach(p => f.call(t, o[p], p, o));
export const objReduce = (o, f = () => {}, r) =>
  objKeys(o).reduce((r, p) => f(r, o[p], p, o), r);
export const objMap = (o, f = () => {}, t = this) =>
  objReduce(o, (r, v, p) => ({ ...r, [p]: f.call(t, v, p, o) }), {});
export const objValues = o => objReduce(o, (a, v) => a.concat([v]), []);
export const iselem = e =>
  isset(e) &&
  (e instanceof Element || e instanceof Window || e instanceof Document);
export const getStyle = d => d.currentStyle || window.getComputedStyle(d);
export const stdDoms = (...doms) =>
  doms.reduce((arr, dom) => {
    if (iselem(dom)) {
